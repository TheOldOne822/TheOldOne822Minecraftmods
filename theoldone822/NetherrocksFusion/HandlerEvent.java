		...
		if (event.entity instanceof EntityPlayer) {
			...
			if (event.entity instanceof EntityPlayer) {
				...
				if (helmet != null && chest != null && legs != null && boots != null) {
					if ((helmet.getItem() == alexndr.plugins.Netherrocks.Content.fyrite_helmet || helmet.getItem() == Content.cinderstoneHelm || helmet.getItem() == Content.dragonbezoarHelm || helmet.getItem() == Content.dragonbezoarChainHelm /*|| (PluginChecks.getTungstenInstalled() && helmet.getItem() ==  akkamaddi.simpletungsten.code.SimpleTungstenCore.valframHelm)*/)
							&& (chest.getItem() == alexndr.plugins.Netherrocks.Content.fyrite_chestplate || chest.getItem() == Content.cinderstoneChest || chest.getItem() == Content.dragonbezoarChest || chest.getItem() == Content.dragonbezoarChainChest /*|| (PluginChecks.getTungstenInstalled() && chest.getItem() == akkamaddi.simpletungsten.code.SimpleTungstenCore.valframChest)*/)
							&& (legs.getItem() == alexndr.plugins.Netherrocks.Content.fyrite_leggings || legs.getItem() == Content.cinderstoneLegs || legs.getItem() == Content.dragonbezoarLegs || legs.getItem() == Content.dragonbezoarChainLegs /*|| (PluginChecks.getTungstenInstalled() && legs.getItem() == akkamaddi.simpletungsten.code.SimpleTungstenCore.valframLegs)*/)
							&& (boots.getItem() == alexndr.plugins.Netherrocks.Content.fyrite_boots || boots.getItem() == Content.cinderstoneBoots || boots.getItem() == Content.dragonbezoarBoots || boots.getItem() == Content.dragonbezoarChainBoots /*|| (PluginChecks.getTungstenInstalled() && boots.getItem() == akkamaddi.simpletungsten.code.SimpleTungstenCore.valframBoots)*/)) {
	...
	public void onFallDamage(LivingAttackEvent event) {
		if (event.entity instanceof EntityPlayer) {
			...
			if (event.entity instanceof EntityPlayer) {
				...
				if (helmet != null && chest != null && legs != null && boots != null) {
					if ((helmet.getItem() == alexndr.plugins.Netherrocks.Content.illumenite_helmet || helmet.getItem() == Content.cinderstoneHelm || helmet.getItem() == Content.dragonbezoarHelm || helmet.getItem() == Content.dragonbezoarChainHelm /*|| (PluginChecks.getCobaltInstalled() && helmet.getItem() == akkamaddi.simplecobalt.code.SimpleCobaltCore.blueDriftSteelHelm)*/)
							&& (chest.getItem() == alexndr.plugins.Netherrocks.Content.illumenite_chestplate || chest.getItem() == Content.cinderstoneChest || chest.getItem() == Content.dragonbezoarChest || chest.getItem() == Content.dragonbezoarChainChest /*|| (PluginChecks.getCobaltInstalled() && chest.getItem() == akkamaddi.simplecobalt.code.SimpleCobaltCore.blueDriftSteelChest)*/)
							&& (legs.getItem() == alexndr.plugins.Netherrocks.Content.illumenite_leggings || legs.getItem() == Content.cinderstoneLegs || legs.getItem() == Content.dragonbezoarLegs || legs.getItem() == Content.dragonbezoarChainLegs /*|| (PluginChecks.getCobaltInstalled() && legs.getItem() == akkamaddi.simplecobalt.code.SimpleCobaltCore.blueDriftSteelLegs)*/)
							&& (boots.getItem() == alexndr.plugins.Netherrocks.Content.illumenite_boots || boots.getItem() == Content.cinderstoneBoots || boots.getItem() == Content.dragonbezoarBoots || boots.getItem() == Content.dragonbezoarChainBoots /*|| (PluginChecks.getCobaltInstalled() && boots.getItem() == akkamaddi.simplecobalt.code.SimpleCobaltCore.blueDriftSteelBoots)*/)) {
