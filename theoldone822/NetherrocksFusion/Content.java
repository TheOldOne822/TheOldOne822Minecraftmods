...
public class Content 
{
	...
	{
		//Block Properties
		cinderstoneBlock = new SimpleOre(IDs.cinderstoneBlockID, Material.iron, "netherrocksfusion", SimpleOres.tabSimpleBlocks).setHardness(Settings.cinderstoneBlockHardness).setResistance(Settings.cinderstoneBlockResistance).setLightValue(Settings.cinderstoneBlockLightValue).setCreativeTab(SimpleOres.tabSimpleBlocks).setUnlocalizedName("netherrocksfusion:cinderstoneBlock").setTextureName("netherrocksfusion:cinderstoneBlock");
		...
		pyralisBlock = new SimpleOre(IDs.pyralisBlockID, Material.iron, "netherrocksfusion", SimpleOres.tabSimpleBlocks).setHardness(Settings.pyralisBlockHardness).setResistance(Settings.pyralisBlockResistance).setLightValue(Settings.pyralisBlockLightValue).setCreativeTab(SimpleOres.tabSimpleBlocks).setUnlocalizedName("netherrocksfusion:pyralisBlock").setTextureName("netherrocksfusion:pyralisBlock");
		dragonbezoarBlock = new SimpleOre(IDs.dragonbezoarBlockID, Material.iron, "netherrocksfusion", SimpleOres.tabSimpleBlocks).setHardness(Settings.dragonbezoarBlockHardness).setResistance(Settings.dragonbezoarBlockResistance).setLightValue(Settings.dragonbezoarBlockLightValue).setCreativeTab(SimpleOres.tabSimpleBlocks).setUnlocalizedName("netherrocksfusion:dragonbezoarBlock").setTextureName("netherrocksfusion:dragonbezoarBlock");
