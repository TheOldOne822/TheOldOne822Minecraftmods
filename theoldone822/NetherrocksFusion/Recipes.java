...
public class Recipes {
	...
	public static void doRecipes() {
		...
		GameRegistry.addRecipe(new ItemStack(Content.pyralisChain, 6), new Object[] { " Y ", "X X", " X ", Character.valueOf('X'), Content.pyralisIngot, Character.valueOf('Y'), alexndr.plugins.Netherrocks.Content.dragonstone_gem});
		GameRegistry.addRecipe(new ItemStack(Content.pyralisChain, 6), new Object[] { " X ", "Y X", " X ", Character.valueOf('X'), Content.pyralisIngot, Character.valueOf('Y'), alexndr.plugins.Netherrocks.Content.dragonstone_gem});
		GameRegistry.addRecipe(new ItemStack(Content.pyralisChain, 6), new Object[] { " X ", "X Y", " X ", Character.valueOf('X'), Content.pyralisIngot, Character.valueOf('Y'), alexndr.plugins.Netherrocks.Content.dragonstone_gem});
		GameRegistry.addRecipe(new ItemStack(Content.pyralisChain, 6), new Object[] { " X ", "X X", " Y ", Character.valueOf('X'), Content.pyralisIngot, Character.valueOf('Y'), alexndr.plugins.Netherrocks.Content.dragonstone_gem});
		...
		// Smelting
		FusionFurnaceRecipes.addSmelting(new ItemStack(alexndr.plugins.Netherrocks.Content.fyrite_ingot), new ItemStack(alexndr.plugins.Netherrocks.Content.illumenite_ingot), new ItemStack(Items.gunpowder),
				new ItemStack(Content.smallCinderstoneChunk), 2.0F);
		FusionFurnaceRecipes.addSmelting(new ItemStack(alexndr.plugins.Netherrocks.Content.fyrite_ingot), new ItemStack(alexndr.plugins.Netherrocks.Content.illumenite_ingot), new ItemStack(Items.redstone),
				new ItemStack(Content.mediumCinderstoneChunk), 3.0F);
		FusionFurnaceRecipes.addSmelting(new ItemStack(alexndr.plugins.Netherrocks.Content.fyrite_ingot), new ItemStack(alexndr.plugins.Netherrocks.Content.illumenite_ingot), new ItemStack(Items.blaze_powder),
				new ItemStack(Content.largeCinderstoneChunk), 10.0F);

		FusionFurnaceRecipes.addSmelting(new ItemStack(alexndr.plugins.Netherrocks.Content.malachite_ingot), new ItemStack(alexndr.plugins.Netherrocks.Content.ashstone_gem), new ItemStack(Items.redstone),
				new ItemStack(Content.smallThrakaChunk), 6.0F);
		FusionFurnaceRecipes.addSmelting(new ItemStack(alexndr.plugins.Netherrocks.Content.malachite_ingot), new ItemStack(alexndr.plugins.Netherrocks.Content.ashstone_gem), new ItemStack(Items.blaze_powder),
				new ItemStack(Content.mediumThrakaChunk), 10.0F);
		FusionFurnaceRecipes.addSmelting(new ItemStack(alexndr.plugins.Netherrocks.Content.malachite_ingot), new ItemStack(alexndr.plugins.Netherrocks.Content.ashstone_gem), new ItemStack(Items.ghast_tear),
				new ItemStack(Content.largeThrakaChunk), 30.0F);

		FusionFurnaceRecipes.addSmelting(new ItemStack(Content.largeCinderstoneChunk), new ItemStack(alexndr.plugins.Netherrocks.Content.dragonstone_gem), new ItemStack(Items.blaze_powder),
				new ItemStack(Content.smallPyralisChunk), 6.0F);
		FusionFurnaceRecipes.addSmelting(new ItemStack(Content.largeCinderstoneChunk), new ItemStack(alexndr.plugins.Netherrocks.Content.dragonstone_gem), new ItemStack(Items.ghast_tear),
				new ItemStack(Content.mediumPyralisChunk), 10.0F);
		FusionFurnaceRecipes.addSmelting(new ItemStack(Content.largeCinderstoneChunk), new ItemStack(alexndr.plugins.Netherrocks.Content.dragonstone_gem), new ItemStack(Items.skull, 1, 1),
				new ItemStack(Content.largePyralisChunk), 30.0F);

		if(Loader.isModLoaded("simpleores") && alexndr.plugins.Fusion.Settings.enableSimpleOres){
		FusionFurnaceRecipes.addSmelting(new ItemStack(alexndr.plugins.Fusion.addons.ContentSimpleOres.large_sinisite_chunk), new ItemStack(Content.largePyralisChunk), new ItemStack(Items.skull, 1, 1),
				new ItemStack(Content.smallDragonBezoarChunk), 12.0F);
		FusionFurnaceRecipes.addSmelting(new ItemStack(alexndr.plugins.Fusion.addons.ContentSimpleOres.large_sinisite_chunk), new ItemStack(Content.largePyralisChunk), new ItemStack(Blocks.dragon_egg, 0),
				new ItemStack(Content.mediumDragonBezoarChunk), 20.0F);
		FusionFurnaceRecipes.addSmelting(new ItemStack(alexndr.plugins.Fusion.addons.ContentSimpleOres.large_sinisite_chunk), new ItemStack(Content.largePyralisChunk), new ItemStack(Items.nether_star),
		...
		if (Settings.enableRecycling) {
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.cinderstoneHelm, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.quartz, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeCinderstoneChunk), 15.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.cinderstoneChest, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.quartz, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeCinderstoneChunk, 2, 0), 30.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.cinderstoneLegs, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.quartz, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeCinderstoneChunk, 2, 0), 30.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.cinderstoneBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.quartz, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeCinderstoneChunk), 15.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.cinderstoneSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.quartz, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeCinderstoneChunk), 15.0F);

			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.thrakaHelm, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.glowstone_dust, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeThrakaChunk), 15.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.thrakaChest, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.glowstone_dust, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeThrakaChunk, 2, 0), 30.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.thrakaLegs, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.glowstone_dust, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeThrakaChunk, 2, 0), 30.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.thrakaBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.glowstone_dust, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeThrakaChunk), 15.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.thrakaSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.glowstone_dust, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeThrakaChunk), 15.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.thrakaShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.glowstone_dust, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeThrakaChunk), 15.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.thrakaPick, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.glowstone_dust, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeThrakaChunk), 15.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.thrakaAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.glowstone_dust, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeThrakaChunk), 15.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.thrakaHoe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.glowstone_dust, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Content.largeThrakaChunk), 15.0F);

			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisChainHelm, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisChainChest, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk, 2, 0), 40.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisChainLegs, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk, 2, 0), 40.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisChainHelm, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisChest, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk, 2, 0), 40.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisLegs, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk, 2, 0), 40.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisPick, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.pyralisHoe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largePyralisChunk), 20.0F);

			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarChainHelm, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarChainChest, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk, 2, 0), 40.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarChainLegs, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk, 2, 0), 40.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarChainBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarHelm, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarChest, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk, 2, 0), 40.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarLegs, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack, 2, 0), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk, 2, 0), 40.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarPick, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk), 20.0F);
			FusionFurnaceRecipes.addSmelting(new ItemStack(Content.dragonbezoarHoe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.netherrack), new ItemStack(Items.lava_bucket), new ItemStack(Content.largeDragonBezoarChunk), 20.0F);
		}
