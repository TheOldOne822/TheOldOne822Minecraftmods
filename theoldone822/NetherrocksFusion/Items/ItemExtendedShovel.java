...
public class ItemExtendedShovel extends ItemSpade
{
	...
	public ItemExtendedShovel setUnlocalizedName(String unlocalizedName)
	{
	...
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase) {
		if (this.itemID == Content.extendeddragonbezoarShovel.itemID) {
		...
		if (this.itemID == Content.extendedpyralisShovel.itemID) {
			par1ItemStack.damageItem(1, par3EntityLivingBase);
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
		if (this.itemID == Content.extendeddragonbezoarShovel.itemID || this.itemID == Content.extendedpyralisShovel.itemID) {
			if (par7 == 0) {
				par5--;
			}
			if (par7 == 1) {
	...
	public boolean onBlockStartBreak(ItemStack itemstack, int i, int j, int k, EntityPlayer player) {
		...
		if (itemID == Content.extendeddragonbezoarShovel.itemID && !player.capabilities.isCreativeMode) {
			Boolean flag = false;
