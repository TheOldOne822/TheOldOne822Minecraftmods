...
public class NetherSword extends ItemSword {
	...
	public NetherSword(ToolMaterial enumtoolmaterial) {
	...
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase) {
		if (this == Content.cinderstoneSword || this == Content.dragonbezoarSword) {
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
		if (this == Content.cinderstoneSword || this == Content.dragonbezoarSword || this == Content.pyralisSword) {
			if (par7 == 0) {
				par5--;
			}
			if (par7 == 1) {
		...
		if ((this == Content.cinderstoneSword || this == Content.dragonbezoarSword) && !player.capabilities.isCreativeMode) {
			Boolean flag = false;
