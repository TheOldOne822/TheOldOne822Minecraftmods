...
public class NetherSword extends ItemSword {
	...
	public NetherSword(int i, EnumToolMaterial enumtoolmaterial) {
	...
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase) {
		if (this.itemID == Content.cinderstoneSword.itemID || this.itemID == Content.dragonbezoarSword.itemID) {
		...
		if (this.itemID == Content.pyralisSword.itemID) {
			par1ItemStack.damageItem(1, par3EntityLivingBase);
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
		if (this.itemID == Content.cinderstoneSword.itemID || this.itemID == Content.dragonbezoarSword.itemID || this.itemID == Content.pyralisSword.itemID) {
			if (par7 == 0) {
				par5--;
			}
			if (par7 == 1) {
		...
		if ((itemID == Content.cinderstoneSword.itemID || itemID == Content.dragonbezoarSword.itemID) && !player.capabilities.isCreativeMode) {
			Boolean flag = false;
