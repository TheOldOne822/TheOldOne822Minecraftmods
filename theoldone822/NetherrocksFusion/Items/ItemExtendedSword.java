...
import static theoldone822.NetherrocksFusion.NetherrocksFusion.extendedValues.increaseSwordDamage;
import static theoldone822.NetherrocksFusion.NetherrocksFusion.extendedValues.increaseSwordDurability;
import static theoldone822.NetherrocksFusion.NetherrocksFusion.extendedValues.increaseSwordMiningSpeed;
...
public class ItemExtendedSword extends ItemSword
{
	...
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase) {
		if (this.itemID == Content.extendedcinderstoneSword.itemID || this.itemID == Content.extendeddragonbezoarSword.itemID) {
		...
		if (this.itemID == Content.extendedpyralisSword.itemID) {
			par1ItemStack.damageItem(1, par3EntityLivingBase);
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
		if (this.itemID == Content.extendedcinderstoneSword.itemID || this.itemID == Content.extendeddragonbezoarSword.itemID || this.itemID == Content.extendedpyralisSword.itemID) {
			if (par7 == 0) {
				par5--;
			}
			if (par7 == 1) {
		...
		if ((itemID == Content.extendedcinderstoneSword.itemID || itemID == Content.extendeddragonbezoarSword.itemID) && !player.capabilities.isCreativeMode) {
			Boolean flag = false;
