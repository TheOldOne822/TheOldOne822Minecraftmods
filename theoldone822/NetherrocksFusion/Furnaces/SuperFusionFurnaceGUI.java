...
public class SuperFusionFurnaceGUI extends GuiContainer
{
    private SuperFusionFurnaceTileEntity furnaceInventory;
    ...
    public SuperFusionFurnaceGUI(InventoryPlayer par1InventoryPlayer, SuperFusionFurnaceTileEntity par2TileEntityFurnace)
    {
        super(new SuperFusionFurnaceContainer(par1InventoryPlayer, par2TileEntityFurnace));
