...
public class SuperFurnaceGUI extends GuiContainer {
	private SuperFurnaceTileEntity furnaceInventory;

	private static final ResourceLocation field_110410_t = new ResourceLocation("textures/gui/container/furnace.png");

	public SuperFurnaceGUI(InventoryPlayer par1InventoryPlayer, SuperFurnaceTileEntity par2TileEntityFurnace) {
		super(new SuperFurnaceContainer(par1InventoryPlayer, par2TileEntityFurnace));
