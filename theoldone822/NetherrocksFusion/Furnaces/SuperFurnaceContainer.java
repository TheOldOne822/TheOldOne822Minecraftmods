...
public class SuperFurnaceContainer extends Container {
	private SuperFurnaceTileEntity furnace;
	private int lastCookTime = 0;
	private int lastBurnTime = 0;
	private int lastItemBurnTime = 0;

	public SuperFurnaceContainer(InventoryPlayer par1InventoryPlayer, SuperFurnaceTileEntity par2TileEntityFurnace) {
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
		...
		if (var4 != null && var4.getHasStack()) {
			...
			if (par2 == 2) {
				...
				} else if (SuperFurnaceTileEntity.isItemFuel(var5)) {
