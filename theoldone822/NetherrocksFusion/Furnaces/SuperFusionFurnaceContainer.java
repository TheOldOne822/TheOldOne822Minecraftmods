...
public class SuperFusionFurnaceContainer extends Container
{
    private SuperFusionFurnaceTileEntity furnace;
     ...
     */
    public SuperFusionFurnaceContainer(InventoryPlayer par1InventoryPlayer, SuperFusionFurnaceTileEntity par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SuperFusionFurnaceSlot(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 79, 34)); //Output
