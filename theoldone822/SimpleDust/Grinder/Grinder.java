...
public class Grinder extends BlockContainer {
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		return Item.getItemFromBlock(SimpleDust.grinder);
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister.registerIcon("simpleoresdust:" + "grinderSide");
		this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "simpleoresdust:" + "grinderFrontLit" : "simpleoresdust:" + "grinderFront");
		this.furnaceIconTop = par1IconRegister.registerIcon("simpleoresdust:" + "grinderTop");
	}
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
		if (par1World.isRemote) {
			...
			par5EntityPlayer.openGui(SimpleDust.instance, 0, par1World, par2, par3, par4);
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4) {
		...
		if (par0) {
			par1World.setBlock(par2, par3, par4, SimpleDust.grinderOn);
		} else {
			par1World.setBlock(par2, par3, par4, SimpleDust.grinder);
		}
