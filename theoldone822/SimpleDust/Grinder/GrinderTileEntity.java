...
public class GrinderTileEntity extends TileEntity implements ISidedInventory {
	private static final int[] slots_top = new int[] { 0 };
	private static final int[] slots_bottom = new int[] { 2, 1 };
	private static final int[] slots_sides = new int[] { 1 };
	private static int cooktime = (int) (800 /* Settings.grayFurnaceSpeed*/);
		...
		if (par0ItemStack == null) {
			...
			if (par0ItemStack.getItem() instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.air) {
				...
				if (block == Blocks.wooden_slab) {
					return (int) (150 / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
				}

				if (block.getMaterial() == Material.wood) {
					return (int) (300 / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
				}

				if (block == Blocks.coal_block) {
					return (int) (16000 / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
				}
			}

			if (item instanceof ItemTool && ((ItemTool) item).getToolMaterialName().equals("WOOD"))
				return (int) (200 / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
			if (item instanceof ItemSword && ((ItemSword) item).getToolMaterialName().equals("WOOD"))
				return (int) (200 / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
			if (item instanceof ItemHoe && ((ItemHoe) item).getToolMaterialName().equals("WOOD"))
				return (int) (200 / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
			if (item == Items.stick)
				return (int) (100 / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
			if (item == Items.coal)
				return (int) (1600 / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
			if (item == Items.lava_bucket)
				return (int) (20000 / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
			if (item == Item.getItemFromBlock(Blocks.sapling))
				return (int) (100 / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
			if (item == Items.blaze_rod)
				return (int) (2400 / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
			return (int) (GameRegistry.getFuelValue(par0ItemStack) / 2 /* Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed*/);
		}
	}
