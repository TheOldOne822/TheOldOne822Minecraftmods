...
{
    private final TileEntityGrinder furnace;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;

    public ContainerGrinder(InventoryPlayer par1InventoryPlayer, TileEntity par2TileEntityGrinder)
    {
        furnace = (TileEntityGrinder) par2TileEntityGrinder;
        addSlotToContainer(new Slot(furnace, 0, 56, 17));
        addSlotToContainer(new Slot(furnace, 1, 56, 53));
        addSlotToContainer(new SlotGrinder(par1InventoryPlayer.player, furnace, 2, 116, 35));
        int var3;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (var3 != null && var3.getHasStack())
        {
            ...
            {
                if (GrinderRecipes.smelting().getGrindingResult(var4) != null)
                {
                ...
                else if (TileEntityGrinder.isItemFuel(var4))
                {
