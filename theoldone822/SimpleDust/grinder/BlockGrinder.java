...
import theoldone822.SimpleDust.GuiRegistry;
...
public class BlockGrinder extends BlockContainer
{
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            final TileEntityGrinder var5 = (TileEntityGrinder) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        final TileEntityGrinder tec = new TileEntityGrinder();
        ...
        case 0:
        {
            tec.setSpeed((int) (20 * SimpleDust.stoneGrinderSpeed));
            break;
        }
        case 1:
        {
            tec.setSpeed((int) (20 * SimpleDust.copperGrinderSpeed));
            break;
        }
        case 2:
        {
            tec.setSpeed((int) (20 * SimpleDust.ironGrinderSpeed));
            break;
        }
        case 3:
        {
            tec.setSpeed((int) (20 * SimpleDust.mythrilGrinderSpeed));
            break;
        }
        case 4:
        {
            tec.setSpeed((int) (20 * SimpleDust.adamantiumGrinderSpeed));
            break;
        }
        default:
            break;
        ...
        return tec;
        // return new BC_TileEntityGrinder();
    }
    ...
    public int getLightValue(IBlockAccess world, int x, int y, int z)
    {
        try
        {
            final TileEntityGrinder var6 = (TileEntityGrinder) world.getBlockTileEntity(x, y, z);
    ...
    {
        return SimpleDust.grinder.blockID;
    }
    ...
    public boolean onBlockActivated(World par1World, int x, int y, int z, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        final TileEntityGrinder var6 = (TileEntityGrinder) par1World.getBlockTileEntity(x, y, z);
        par1World.getBlockMetadata(x, y, z);
        if (var6 != null)
        {
            // par5EntityPlayer.openGui(SimpleDust.instance, type,
            // par1World, x, y, z);
            GuiRegistry.openGui("Grinder", SimpleDust.instance, par5EntityPlayer, par1World, x, y, z);
        }
    ...
    public void onBlockPlacedBy(World par1World, int x, int y, int z, EntityLivingBase par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        if (var6 == 0)
        {
            ((TileEntityGrinder) par1World.getBlockTileEntity(x, y, z)).setDirection(2);
        }

        if (var6 == 1)
        {
            ((TileEntityGrinder) par1World.getBlockTileEntity(x, y, z)).setDirection(5);
        }

        if (var6 == 2)
        {
            ((TileEntityGrinder) par1World.getBlockTileEntity(x, y, z)).setDirection(3);
        }

        if (var6 == 3)
        {
            ((TileEntityGrinder) par1World.getBlockTileEntity(x, y, z)).setDirection(4);
        }

        final TileEntityGrinder tec = (TileEntityGrinder) par1World.getBlockTileEntity(x, y, z);
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        iconArray[0] = par1IconRegister.registerIcon("SimpleOresDust:GrinderStone");
        iconArray[1] = par1IconRegister.registerIcon("SimpleOresDust:GrinderCopper");
        iconArray[2] = par1IconRegister.registerIcon("SimpleOresDust:GrinderIron");
        iconArray[3] = par1IconRegister.registerIcon("SimpleOresDust:GrinderMythril");
        iconArray[4] = par1IconRegister.registerIcon("SimpleOresDust:GrinderAdamantium");
    }
