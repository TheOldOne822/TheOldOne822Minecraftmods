...
public class GrinderContainer extends Container {
	private GrinderTileEntity furnace;
	private int lastCookTime = 0;
	private int lastBurnTime = 0;
	private int lastItemBurnTime = 0;

	public GrinderContainer(InventoryPlayer par1InventoryPlayer, GrinderTileEntity par2TileEntityFurnace) {
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
		...
		if (var4 != null && var4.getHasStack()) {
			...
			if (par2 == 2) {
				...
				} else if (GrinderTileEntity.isItemFuel(var5)) {
