...
public class Grinder3 extends BlockContainer {
	/**
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		return Item.getItemFromBlock(SimpleOreGrinder.grinder3);
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister.registerIcon("simpleoregrinder:" + "grinderSideIron");
		this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "simpleoregrinder:" + "grinderFrontLitIron" : "simpleoregrinder:" + "GrinderFrontIron");
		this.furnaceIconTop = par1IconRegister.registerIcon("simpleoregrinder:" + "grinderTopIron");
	}
...
//			GrinderTileEntity tileentityfurnace = (GrinderTileEntity) par1World.getTileEntity(par2, par3, par4);
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4) {
		...
		if (par0) {
			par1World.setBlock(par2, par3, par4, SimpleOreGrinder.grinderOn3);
		} else {
			par1World.setBlock(par2, par3, par4, SimpleOreGrinder.grinder3);
		}
