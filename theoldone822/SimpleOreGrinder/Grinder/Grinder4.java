...
public class Grinder4 extends BlockContainer {
	/**
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		return Item.getItemFromBlock(SimpleOreGrinder.grinder4);
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister.registerIcon("simpleoregrinder:" + "grinderSideMythril");
		this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "simpleoregrinder:" + "grinderFrontLitMythril" : "simpleoregrinder:" + "GrinderFrontMythril");
		this.furnaceIconTop = par1IconRegister.registerIcon("simpleoregrinder:" + "grinderTopMythril");
	}
...
//			GrinderTileEntity tileentityfurnace = (GrinderTileEntity) par1World.getTileEntity(par2, par3, par4);
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4) {
		...
		if (par0) {
			par1World.setBlock(par2, par3, par4, SimpleOreGrinder.grinderOn4);
		} else {
			par1World.setBlock(par2, par3, par4, SimpleOreGrinder.grinder4);
		}
