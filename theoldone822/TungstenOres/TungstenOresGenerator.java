...
public class TungstenOresGenerator implements IWorldGenerator {
    /**
    ...
    */
    ...
    {
        for (int x = 0; x < TungstenOres.wolframiteSpawnRate; x++)
        {
            int Xcoord = blockX + random.nextInt(16);
            int Ycoord = random.nextInt(TungstenOres.wolframiteSpawnHeight - TungstenOres.wolframiteMinSpawnHeight);
            int Zcoord = blockZ + random.nextInt(16);
            new WorldGenHelper(TungstenOres.oreWolframite.blockID, TungstenOres.wolframiteVeinSize, Block.stone).generate(world, random, Xcoord, Ycoord + TungstenOres.wolframiteMinSpawnHeight, Zcoord);
        }
    }
}