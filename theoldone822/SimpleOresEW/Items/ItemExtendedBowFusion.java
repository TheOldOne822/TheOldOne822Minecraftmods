...
public class ItemExtendedBowFusion extends ItemBow {
	/**
	 ...
	 */
	public ItemExtendedBowFusion(int par1, int dam, EnumToolMaterial enumtoolmaterial) {
		super(par1);
		this.maxStackSize = 1;
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4) {
		...
		if ((flag) || (par3EntityPlayer.inventory.hasItem(Item.arrow.itemID))) {
			...
			if (!par2World.isRemote) {
				...
				if (itemID == SimpleOresEW.extendedthyriumBow.itemID) {
					var8.setDamage(var8.getDamage() + SimpleOres.plugins.fusion.Settings.thyriumBowDamageModifier * increaseBowDamage * 0.5D + 0.5D);
				}

				if (itemID == SimpleOresEW.extendedsinisiteBow.itemID) {
					var8.setDamage(var8.getDamage() + SimpleOres.plugins.fusion.Settings.sinisiteBowDamageModifier * increaseBowDamage * 0.5D + 0.5D);
