...
public class ItemExtendedNetherAxe extends ItemAxe
{
    public ItemExtendedNetherAxe(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
	...
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase) {
		if (PluginChecks.getNetherFusionInstalled() && this.itemID == SimpleOresEW.extendeddragonbezoarAxe.itemID) {
