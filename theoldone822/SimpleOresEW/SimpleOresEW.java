...
public class SimpleOresEW {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		simpleID = (config.getItem("SO Base ID", 24034)).getInt();
		fusionID = (config.getItem("Fusion Base ID", 24084)).getInt();
		netherID = (config.getItem("Netherrocks Base ID", 24123)).getInt();
		silverID = (config.getItem("Silver Base ID", 24202)).getInt();
		netherfusionID = (config.getItem("Netherrocks Fusion Base ID", 0)).getInt();
		arsenicID = (config.getItem("Arsenic Base ID", 24212)).getInt();
		alchemyID = (config.getItem("Alchemy Base ID", 24244)).getInt();
		cthonID = (config.getItem("Cthon Base ID", 24283)).getInt();
		glitterID = (config.getItem("Glittering Gold Base ID", 24292)).getInt();
		haditeID = (config.getItem("Hadite Base ID", 24313)).getInt();
		cobaltID = (config.getItem("Cobalt Base ID", 24321)).getInt();
		tungstenID = (config.getItem("Tungsten Base ID", 24357)).getInt();
		sterlingID = (config.getItem("Sterling Base ID", 24384)).getInt();
	...
	public void Initiatesimpleoresew(FMLInitializationEvent initEvent) {
		...
		if (PluginChecks.getNetherFusionInstalled()) {
			...
			extendedcinderstoneHelm =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedcinderstoneHelmID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorCinderstone, rendererextendedCinderstone, 0,
							"cinderstone").setUnlocalizedName("netherrocksfusion:extendedcinderstoneHelm").setTextureName(
							"netherrocksfusion:extendedcinderstoneHelm");
			extendedcinderstoneChest =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedcinderstoneChestID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorCinderstone, rendererextendedCinderstone, 1,
							"cinderstone").setUnlocalizedName("netherrocksfusion:extendedcinderstoneChest").setTextureName(
							"netherrocksfusion:extendedcinderstoneChest");
			extendedcinderstoneLegs =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedcinderstoneLegsID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorCinderstone, rendererextendedCinderstone, 2,
							"cinderstone").setUnlocalizedName("netherrocksfusion:extendedcinderstoneLegs").setTextureName(
							"netherrocksfusion:extendedcinderstoneLegs");
			extendedcinderstoneBoots =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedcinderstoneBootsID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorCinderstone, rendererextendedCinderstone, 3,
							"cinderstone").setUnlocalizedName("netherrocksfusion:extendedcinderstoneBoots").setTextureName(
							"netherrocksfusion:extendedcinderstoneBoots");
			extendedthrakaHelm =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedthrakaHelmID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorThraka, rendererextendedThraka, 0, "thraka")
							.setUnlocalizedName("netherrocksfusion:extendedthrakaHelm").setTextureName(
									"netherrocksfusion:extendedthrakaHelm");
			extendedthrakaChest =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedthrakaChestID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorThraka, rendererextendedThraka, 1, "thraka")
							.setUnlocalizedName("netherrocksfusion:extendedthrakaChest").setTextureName(
									"netherrocksfusion:extendedthrakaChest");
			extendedthrakaLegs =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedthrakaLegsID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorThraka, rendererextendedThraka, 2, "thraka")
							.setUnlocalizedName("netherrocksfusion:extendedthrakaLegs").setTextureName(
									"netherrocksfusion:extendedthrakaLegs");
			extendedthrakaBoots =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedthrakaBootsID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorThraka, rendererextendedThraka, 3, "thraka")
							.setUnlocalizedName("netherrocksfusion:extendedthrakaBoots").setTextureName(
									"netherrocksfusion:extendedthrakaBoots");
			extendedpyralisHelm =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedpyralisHelmID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorPyralis, rendererextendedPyralis, 0,
							"pyralis").setUnlocalizedName("netherrocksfusion:extendedpyralisHelm").setTextureName(
							"netherrocksfusion:extendedpyralisHelm");
			extendedpyralisChest =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedpyralisChestID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorPyralis, rendererextendedPyralis, 1,
							"pyralis").setUnlocalizedName("netherrocksfusion:extendedpyralisChest").setTextureName(
							"netherrocksfusion:extendedpyralisChest");
			extendedpyralisLegs =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedpyralisLegsID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorPyralis, rendererextendedPyralis, 2,
							"pyralis").setUnlocalizedName("netherrocksfusion:extendedpyralisLegs").setTextureName(
							"netherrocksfusion:extendedpyralisLegs");
			extendedpyralisBoots =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendedpyralisBootsID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorPyralis, rendererextendedPyralis, 3,
							"pyralis").setUnlocalizedName("netherrocksfusion:extendedpyralisBoots").setTextureName(
							"netherrocksfusion:extendedpyralisBoots");
			extendeddragonbezoarHelm =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendeddragonbezoarHelmID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorDragonBezoar, rendererextendedDragonBezoar,
							0, "dragonbezoar").setUnlocalizedName("netherrocksfusion:extendeddragonbezoarHelm").setTextureName(
							"netherrocksfusion:extendeddragonbezoarHelm");
			extendeddragonbezoarChest =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendeddragonbezoarChestID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorDragonBezoar, rendererextendedDragonBezoar,
							1, "dragonbezoar").setUnlocalizedName("netherrocksfusion:extendeddragonbezoarChest")
							.setTextureName("netherrocksfusion:extendeddragonbezoarChest");
			extendeddragonbezoarLegs =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendeddragonbezoarLegsID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorDragonBezoar, rendererextendedDragonBezoar,
							2, "dragonbezoar").setUnlocalizedName("netherrocksfusion:extendeddragonbezoarLegs").setTextureName(
							"netherrocksfusion:extendeddragonbezoarLegs");
			extendeddragonbezoarBoots =
					new ItemExtendedArmor(theoldone822.NetherrocksFusion.IDs.extendeddragonbezoarBootsID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.armorDragonBezoar, rendererextendedDragonBezoar,
							3, "dragonbezoar").setUnlocalizedName("netherrocksfusion:extendeddragonbezoarBoots")
							.setTextureName("netherrocksfusion:extendeddragonbezoarBoots");
			...
			extendedcinderstoneSword =
					new ItemExtendedSword(theoldone822.NetherrocksFusion.IDs.extendedcinderstoneSwordID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolCinderstone).setUnlocalizedName(
							"extendedWorkbenchnf:cinderstoneSword")
							.setTextureName("netherrocksfusion:extendedcinderstoneSword");
			extendedthrakaPick =
					new ItemExtendedPickaxe(theoldone822.NetherrocksFusion.IDs.extendedthrakaPickID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolThraka).setUnlocalizedName(
							"extendedWorkbenchnf:thrakaPick").setTextureName("netherrocksfusion:extendedthrakaPick");
			extendedthrakaAxe =
					new ItemExtendedAxe(theoldone822.NetherrocksFusion.IDs.extendedthrakaAxeID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolThraka).setUnlocalizedName(
							"extendedWorkbenchnf:thrakaAxe").setTextureName("netherrocksfusion:extendedthrakaAxe");
			extendedthrakaShovel =
					new ItemExtendedShovel(theoldone822.NetherrocksFusion.IDs.extendedthrakaShovelID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolThraka).setUnlocalizedName(
							"extendedWorkbenchnf:thrakaShovel").setTextureName("netherrocksfusion:extendedthrakaShovel");
			extendedthrakaSword =
					new ItemExtendedSword(theoldone822.NetherrocksFusion.IDs.extendedthrakaSwordID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolThraka).setUnlocalizedName(
							"extendedWorkbenchnf:thrakaSword").setTextureName("netherrocksfusion:extendedthrakaSword");
			extendedthrakaHoe =
					new ItemExtendedHoe(theoldone822.NetherrocksFusion.IDs.extendedthrakaHoeID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolThraka).setUnlocalizedName(
							"extendedWorkbenchnf:thrakaHoe").setTextureName("netherrocksfusion:extendedthrakaHoe");
			extendedpyralisPick =
					new ItemExtendedPickaxe(theoldone822.NetherrocksFusion.IDs.extendedpyralisPickID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolPyralis).setUnlocalizedName(
							"extendedWorkbenchnf:pyralisPick").setTextureName("netherrocksfusion:extendedpyralisPick");
			extendedpyralisAxe =
					new ItemExtendedAxe(theoldone822.NetherrocksFusion.IDs.extendedpyralisAxeID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolPyralis).setUnlocalizedName(
							"extendedWorkbenchnf:pyralisAxe").setTextureName("netherrocksfusion:extendedpyralisAxe");
			extendedpyralisShovel =
					new ItemExtendedShovel(theoldone822.NetherrocksFusion.IDs.extendedpyralisShovelID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolPyralis).setUnlocalizedName(
							"extendedWorkbenchnf:pyralisShovel").setTextureName("netherrocksfusion:extendedpyralisShovel");
			extendedpyralisSword =
					new ItemExtendedSword(theoldone822.NetherrocksFusion.IDs.extendedpyralisSwordID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolPyralis).setUnlocalizedName(
							"extendedWorkbenchnf:pyralisSword").setTextureName("netherrocksfusion:extendedpyralisSword");
			extendedpyralisHoe =
					new ItemExtendedHoe(theoldone822.NetherrocksFusion.IDs.extendedpyralisHoeID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolPyralis).setUnlocalizedName(
							"extendedWorkbenchnf:pyralisHoe").setTextureName("netherrocksfusion:extendedpyralisHoe");
			extendeddragonbezoarPick =
					new ItemExtendedPickaxe(theoldone822.NetherrocksFusion.IDs.extendeddragonbezoarPickID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolDragonBezoar).setUnlocalizedName(
							"extendedWorkbenchnf:dragonbezoarPick")
							.setTextureName("netherrocksfusion:extendeddragonbezoarPick");
			extendeddragonbezoarAxe =
					new ItemExtendedAxe(theoldone822.NetherrocksFusion.IDs.extendeddragonbezoarAxeID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolDragonBezoar).setUnlocalizedName(
							"extendedWorkbenchnf:dragonbezoarAxe").setTextureName("netherrocksfusion:extendeddragonbezoarAxe");
			extendeddragonbezoarShovel =
					new ItemExtendedShovel(theoldone822.NetherrocksFusion.IDs.extendeddragonbezoarShovelID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolDragonBezoar).setUnlocalizedName(
							"extendedWorkbenchnf:dragonbezoarShovel").setTextureName(
							"netherrocksfusion:extendeddragonbezoarShovel");
			extendeddragonbezoarSword =
					new ItemExtendedSword(theoldone822.NetherrocksFusion.IDs.extendeddragonbezoarSwordID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolDragonBezoar).setUnlocalizedName(
							"extendedWorkbenchnf:dragonbezoarSword").setTextureName(
							"netherrocksfusion:extendeddragonbezoarSword");
			extendeddragonbezoarHoe =
					new ItemExtendedHoe(theoldone822.NetherrocksFusion.IDs.extendeddragonbezoarHoeID,
							theoldone822.NetherrocksFusion.NetherrocksFusion.toolDragonBezoar).setUnlocalizedName(
							"extendedWorkbenchnf:dragonbezoarHoe").setTextureName("netherrocksfusion:extendeddragonbezoarHoe");
			extendeddragonbezoarBow =
					(ItemBow) new ItemExtendedBow(theoldone822.NetherrocksFusion.IDs.extendeddragonbezoarBowID, 1200,
							...
							.setTextureName("netherrocksfusion:extendeddragonbezoarBow");
			extendeddragonbezoarShears =
					new ItemExtendedShears(theoldone822.NetherrocksFusion.IDs.extendeddragonbezoarShearsID, 9300)
							.setUnlocalizedName("extendedWorkbenchnf:dragonbezoarShears").setTextureName(
									"netherrocksfusion:extendeddragonbezoarShears");
		...
		if (PluginChecks.getTungstenInstalled()) {
			{
				Object[] material =
						new Object[] { Item.ingotIron, Item.ingotIron, Item.ingotIron, Item.ingotIron, Item.ingotIron,
								...
								SimpleOres.plugins.akkamaddi.simpletungsten.SimpleTungstenCore.valframIngot };
				EnumToolMaterial[] sotool =
						new EnumToolMaterial[] { EnumToolMaterial.WOOD, EnumToolMaterial.WOOD, EnumToolMaterial.WOOD,
								EnumToolMaterial.WOOD, EnumToolMaterial.WOOD, EnumToolMaterial.WOOD, EnumToolMaterial.WOOD,
								EnumToolMaterial.WOOD, EnumToolMaterial.WOOD, EnumToolMaterial.WOOD, EnumToolMaterial.WOOD,
								...
								SimpleOres.plugins.akkamaddi.simpletungsten.SimpleTungstenCore.toolValfram };
				Object[] handle =
						new Object[] { Block.planks, Block.planks, Item.ingotIron, Item.ingotIron, Item.diamond,
								Block.cobblestone, Item.ingotIron, Item.diamond, Item.ingotIron, Item.ingotIron, Item.diamond,
								Item.ingotIron, Item.ingotIron, Block.cobblestone, Block.cobblestone, Block.cobblestone,
...

			{
				...
				EnumArmorMaterial[] soarmor =
						new EnumArmorMaterial[] { EnumArmorMaterial.IRON, EnumArmorMaterial.IRON, EnumArmorMaterial.IRON,
								...
								SimpleOres.plugins.akkamaddi.simpletungsten.SimpleTungstenCore.armorValfram };

				for (int i = 26; i < 29; i++) {
					for (int j = 0; j < 4; j++) {
						armor[i][j] =
								(ItemArmor) new ItemExtendedArmor(tungstenID + 15 + (i - 26) * 4 + j, soarmor[i],
										armorRenderer[i], j, armormatNames[i]).setUnlocalizedName(
										"extendedWorkbenchso:armor" + i + j).setTextureName(
										"SimpleOresEW:armorextended" + armormatNames[i] + armorNames[j]);
						LanguageRegistry.addName(armor[i][j], "Extended " + armormatNames[i] + " " + armorNames[j]);
		...
		if (PluginChecks.getSterlingInstalled()) {
			{
				...
				for (int i = 36; i < 38; i++) {
					...
					item[0][i] =
							new ItemExtendedSword(sterlingID + (i - 36) * 5 + 0, sotool[i]).setUnlocalizedName(
									"extendedWorkbenchso:tool0" + i).setTextureName(
									"SimpleOresEW:tool" + toolmatNames[i] + "Sword");
					item[1][i] =
							new ItemExtendedShovel(sterlingID + (i - 36) * 5 + 1, sotool[i]).setUnlocalizedName(
									"extendedWorkbenchso:tool1" + i).setTextureName(
									"SimpleOresEW:tool" + toolmatNames[i] + "Shovel");
					item[2][i] =
							new ItemExtendedPickaxe(sterlingID + (i - 36) * 5 + 2, sotool[i]).setUnlocalizedName(
									"extendedWorkbenchso:tool2" + i).setTextureName(
									"SimpleOresEW:tool" + toolmatNames[i] + "Pickaxe");
					item[3][i] =
							new ItemExtendedAxe(sterlingID + (i - 36) * 5 + 3, sotool[i]).setUnlocalizedName(
									"extendedWorkbenchso:tool3" + i).setTextureName(
									"SimpleOresEW:tool" + toolmatNames[i] + "Axe");
					item[4][i] =
							new ItemExtendedHoe(sterlingID + (i - 36) * 5 + 4, sotool[i]).setUnlocalizedName(
									"extendedWorkbenchso:tool4" + i).setTextureName(
									"SimpleOresEW:tool" + toolmatNames[i] + "Hoe");
