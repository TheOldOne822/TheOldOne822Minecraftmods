...
public class MythrilFusionFurnaceTileEntity extends TileEntity implements ISidedInventory
{
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (item instanceof ItemHoe && ((ItemHoe) item).getToolMaterialName().equals("WOOD")) return 375 * MoreFusionFurnaces.mythrilFurnaceMultiplier;
            if (item == Items.stick) return 375 / 2 * MoreFusionFurnaces.mythrilFurnaceMultiplier;
            if (item == Items.coal) return 3000 * MoreFusionFurnaces.mythrilFurnaceMultiplier;
            if (item == Items.lava_bucket) return 37500 * MoreFusionFurnaces.mythrilFurnaceMultiplier;
            if (item == Item.getItemFromBlock(Blocks.sapling)) return 375 / 2 * MoreFusionFurnaces.mythrilFurnaceMultiplier;
            if (item == Items.blaze_rod) return 4500 * MoreFusionFurnaces.mythrilFurnaceMultiplier;
