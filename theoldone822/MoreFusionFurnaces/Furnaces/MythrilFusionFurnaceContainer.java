...
public class MythrilFusionFurnaceContainer extends Container
{
    private MythrilFusionFurnaceTileEntity furnace;
     ...
     */
    public MythrilFusionFurnaceContainer(InventoryPlayer par1InventoryPlayer, MythrilFusionFurnaceTileEntity par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new MythrilFusionFurnaceSlot(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 79, 34)); //Output
