...
public class OnyxFusionFurnaceGUI extends GuiContainer
{
    private OnyxFusionFurnaceTileEntity furnaceInventory;
    ...
    public OnyxFusionFurnaceGUI(InventoryPlayer par1InventoryPlayer, OnyxFusionFurnaceTileEntity par2TileEntityFurnace)
    {
        super(new OnyxFusionFurnaceContainer(par1InventoryPlayer, par2TileEntityFurnace));
