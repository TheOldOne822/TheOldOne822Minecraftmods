...
public class MythrilFusionFurnaceGUI extends GuiContainer
{
    private MythrilFusionFurnaceTileEntity furnaceInventory;
    ...
    public MythrilFusionFurnaceGUI(InventoryPlayer par1InventoryPlayer, MythrilFusionFurnaceTileEntity par2TileEntityFurnace)
    {
        super(new MythrilFusionFurnaceContainer(par1InventoryPlayer, par2TileEntityFurnace));
