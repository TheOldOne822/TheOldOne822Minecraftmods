...
public class OnyxFusionFurnaceContainer extends Container
{
    private OnyxFusionFurnaceTileEntity furnace;
     ...
     */
    public OnyxFusionFurnaceContainer(InventoryPlayer par1InventoryPlayer, OnyxFusionFurnaceTileEntity par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new OnyxFusionFurnaceSlot(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 79, 34)); //Output
