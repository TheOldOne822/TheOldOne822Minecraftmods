...
public class GrayFusionFurnaceGUI extends GuiContainer
{
    private GrayFusionFurnaceTileEntity furnaceInventory;
    ...
    public GrayFusionFurnaceGUI(InventoryPlayer par1InventoryPlayer, GrayFusionFurnaceTileEntity par2TileEntityFurnace)
    {
        super(new GrayFusionFurnaceContainer(par1InventoryPlayer, par2TileEntityFurnace));
