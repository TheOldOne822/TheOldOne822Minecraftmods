...
public class GrayFurnaceContainer extends Container {
	private GrayFurnaceTileEntity furnace;
	private int lastCookTime = 0;
	private int lastBurnTime = 0;
	private int lastItemBurnTime = 0;

	public GrayFurnaceContainer(InventoryPlayer par1InventoryPlayer, GrayFurnaceTileEntity par2TileEntityFurnace) {
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
		...
		if (var4 != null && var4.getHasStack()) {
			...
			if (par2 == 2) {
				...
				} else if (GrayFurnaceTileEntity.isItemFuel(var5)) {
