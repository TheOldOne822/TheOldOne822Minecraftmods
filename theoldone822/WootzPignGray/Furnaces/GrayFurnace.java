...
public class GrayFurnace extends BlockContainer {
	...
	public GrayFurnace(int par1, boolean par2) {
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return Content.grayFurnace.blockID;
	}
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister.registerIcon("wootzpigngray:" + "grayFurnaceSide");
		this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "wootzpigngray:" + "grayFurnaceFrontLit" : "wootzpigngray:" + "grayFurnaceFront");
		this.furnaceIconTop = par1IconRegister.registerIcon("wootzpigngray:" + "grayFurnaceTop");
	}
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
		if (par1World.isRemote) {
			...
			GrayFurnaceTileEntity tileentityfurnace = (GrayFurnaceTileEntity) par1World.getBlockTileEntity(par2, par3, par4);
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4) {
		...
		if (par0) {
			par1World.setBlock(par2, par3, par4, Content.grayFurnaceOn.blockID);
		} else {
			par1World.setBlock(par2, par3, par4, Content.grayFurnace.blockID);
		}
	...
	public TileEntity createNewTileEntity(World par1World) {
		return new GrayFurnaceTileEntity();
	}
