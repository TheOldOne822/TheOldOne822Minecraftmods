...
public class GrayFurnace extends BlockContainer {
	...
	public GrayFurnace(boolean par2) {
		super(Material.rock);
		this.isActive = par2;
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		return Item.getItemFromBlock(Content.grayFurnace);
	}
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4) {
		...
		if (par0) {
			par1World.setBlock(par2, par3, par4, Content.grayFurnaceOn);
		} else {
			par1World.setBlock(par2, par3, par4, Content.grayFurnace);
		}
