...
public class GrayFusionFurnace extends BlockContainer
{
    ...
    public GrayFusionFurnace(boolean par2)
    {
        super(Material.rock);
        this.isActive = par2;
...
//        	else this.setCreativeTab(CoreHelper.simpleores.tabSimpleBlocks);      		
    ...
    {
        return Item.getItemFromBlock(Content.grayFusionFurnace);
    }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, Content.grayFusionFurnaceOn);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, Content.grayFusionFurnace);
        }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6)
    {
        ...
        {
            GrayFusionFurnaceTileEntity tileentityfurnace = (GrayFusionFurnaceTileEntity)par1World.getTileEntity(par2, par3, par4);
