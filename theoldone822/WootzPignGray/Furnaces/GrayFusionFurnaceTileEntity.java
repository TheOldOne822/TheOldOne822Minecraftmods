...
public class GrayFusionFurnaceTileEntity extends TileEntity implements ISidedInventory
{
    ...
    {
        return (int) (this.furnaceCookTime * par1 / (600 / Settings.grayFurnaceSpeed));
    }
    ...
    public int getBurnTimeRemainingScaled(int par1)
    {
        ...
        {
            this.currentItemBurnTime = (int) (600 / Settings.grayFurnaceSpeed);
        }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.isBurning() && this.canSmelt())
            {
                ...
                if (this.furnaceCookTime == 600 / Settings.grayFurnaceSpeed)
                {
            ...
            {
                flag1 = true;
                GrayFusionFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (par0ItemStack.getItem() instanceof ItemBlock && Block.getBlockFromItem(item) != null)
            {
                ...
                {
                    return (int) (1125 / 4 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
                }

                if (block.getMaterial() == Material.wood)
                {
                    return (int) (1125 / 2 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
                }
                
                if (block == Blocks.coal_block)
                {
                    return (int) (30000 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
                }
            }

            if (item instanceof ItemTool && ((ItemTool) item).getToolMaterialName().equals("WOOD")) return (int) (375 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (item instanceof ItemSword && ((ItemSword) item).getToolMaterialName().equals("WOOD")) return (int) (375 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (item instanceof ItemHoe && ((ItemHoe) item).getToolMaterialName().equals("WOOD")) return (int) (375 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (item == Items.stick) return (int) (375 / 2 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (item == Items.coal) return (int) (3000 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (item == Items.lava_bucket) return (int) (37500 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (item == Item.getItemFromBlock(Blocks.sapling)) return (int) (375 / 2 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (item == Items.blaze_rod) return (int) (4500 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            return (int) (GameRegistry.getFuelValue(par0ItemStack) * 1875 / 1000 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
        }
    }
