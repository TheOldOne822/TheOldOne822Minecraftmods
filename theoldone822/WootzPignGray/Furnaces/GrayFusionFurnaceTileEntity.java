...
public class GrayFusionFurnaceTileEntity extends TileEntity implements ISidedInventory
{
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (item instanceof ItemHoe && ((ItemHoe) item).getMaterialName().equals("WOOD")) return (int) (375 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (i == Item.stick.itemID) return (int) (375 / 2 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (i == Item.coal.itemID) return (int) (3000 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (i == Item.bucketLava.itemID) return (int) (37500 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (i == Block.sapling.blockID) return (int) (375 / 2 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
            if (i == Item.blazeRod.itemID) return (int) (4500 * Settings.grayFurnaceFuelMultiplier / Settings.grayFurnaceSpeed);
