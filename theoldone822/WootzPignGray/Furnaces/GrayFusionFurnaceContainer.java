...
public class GrayFusionFurnaceContainer extends Container
{
    private GrayFusionFurnaceTileEntity furnace;
     ...
     */
    public GrayFusionFurnaceContainer(InventoryPlayer par1InventoryPlayer, GrayFusionFurnaceTileEntity par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new GrayFusionFurnaceSlot(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 79, 34)); //Output
