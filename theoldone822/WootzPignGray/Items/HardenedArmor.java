...
public class HardenedArmor extends ItemArmor
{	
	/**
	 ...
	 */
	public HardenedArmor(int ID, EnumArmorMaterial armormaterial, int renderer, int slotNumber, String type, String mod, CreativeTabs tab) 
	{
